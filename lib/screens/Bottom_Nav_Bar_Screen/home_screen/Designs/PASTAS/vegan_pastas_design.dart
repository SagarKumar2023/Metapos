...
class VeganPastasDesign extends StatelessWidget {
  const VeganPastasDesign({super.key});
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            return TraditionalPizzaDesign(
                productName: 'Vegan Pasta Matriciana',
                productDesc: 'Vegan bacon,capsicum,semidried tomatoes capcicum,olives,onions,pineapple,mushrooms,and bacconncini cheese.',
                productPrice: '\$ 16.00',
