...
class BeveragesSoftDrinkDesign extends StatelessWidget {
  const BeveragesSoftDrinkDesign({super.key});
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            return TraditionalPizzaDesign(
                productName: 'Soft Drink (1.25L)',
                productDesc: 'Served with a scoop of ice cream',
                productPrice: '\$ 2.00',
                productImage: 'assets/images/soft_drink.jpg'
            ) ;
          },
        ),
      ],
