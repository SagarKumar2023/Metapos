...
class BeerLagerDesign extends StatelessWidget {
  ...
  const BeerLagerDesign({super.key, this.productHeading, required this.productName, required this.productDesc, required this.productPrice, required this.productImage});
