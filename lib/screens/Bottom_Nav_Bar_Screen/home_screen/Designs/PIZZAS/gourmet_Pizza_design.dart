...
class GourmetPizzaDesign extends StatelessWidget {
  const GourmetPizzaDesign({super.key});
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            return TraditionalPizzaDesign(
                productName: 'AL Fresco',
                productDesc: 'Mozzarella,ham,mushrooms,peperoni,olives,sundried tomatoes,caosicum,onion',
                productPrice: '\$ 16.00-\$24.00',
