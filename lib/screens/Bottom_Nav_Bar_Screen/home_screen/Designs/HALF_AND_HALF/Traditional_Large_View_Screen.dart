...
class TraditionalLargeViewScreen extends StatefulWidget {
  const TraditionalLargeViewScreen({super.key});

  @override
  State<TraditionalLargeViewScreen> createState() => _TraditionalLargeViewScreenState();
}

class _TraditionalLargeViewScreenState extends State<TraditionalLargeViewScreen> {
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          firstHalfWidget(label: 'Napoletana (Large)  \$42.00'),
                          VerticalSpace(height: 10),
                          firstHalfWidget(label: 'Pepperoni (Large)  \$42.00'),
                          VerticalSpace(height: 10),
                          firstHalfWidget(label: 'Hawaiian (Large) \$42.00'),
                          VerticalSpace(height: 10),
                          firstHalfWidget(label: 'Aussie (Large)  \$278.00'),
                          ...
                          VerticalSpace(height: 15),
                          secondHalfWidget(label: 'Napoletana (Large)  \$42.00'),
                          VerticalSpace(height: 10),
                          secondHalfWidget(label: 'Pepperoni (Large)  \$42.00'),
                          VerticalSpace(height: 10),
                          secondHalfWidget(label: 'Hawaiian (Large) \$42.00'),
                          VerticalSpace(height: 10),
                          secondHalfWidget(label: 'Aussie (Large)  \$278.00'),
                          ...
                          Wrap(
                            spacing: 8,
                            runSpacing: 8,
                            children: removeData.map((label) {
                              final isSelected = removeSelected.contains(label);
                              return removeWidget(
                                label: label,
                                isSelected: isSelected,
                                onTap: () {
                                  setState(() {
                                    isSelected
                                        ? removeSelected.remove(label)
                                        : removeSelected.add(label);
                                  });
                                },
                              );
                            }).toList(),
  ...
  Widget firstHalfWidget({required String label,}) {
    bool isSelected = firstHalfSelect == label;
    return GestureDetector(
      onTap: () {
        setState(() {
          firstHalfSelect = label;
        });
      },
      child: Container(
