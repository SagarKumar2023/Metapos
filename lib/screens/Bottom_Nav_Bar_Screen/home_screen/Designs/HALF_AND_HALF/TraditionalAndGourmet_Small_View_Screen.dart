...
class TraditionalAndGourmetSmallViewScreen extends StatefulWidget {
  const TraditionalAndGourmetSmallViewScreen({super.key});

  @override
  State<TraditionalAndGourmetSmallViewScreen> createState() => _TraditionalAndGourmetSmallViewScreenState();
}

class _TraditionalAndGourmetSmallViewScreenState extends State<TraditionalAndGourmetSmallViewScreen> {
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: MyText(
                text: 'Traditional & Gourmet(Small)',
                fontSize: 18,
