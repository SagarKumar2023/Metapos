...
class GourmetLargeViewScreen extends StatefulWidget {
  const GourmetLargeViewScreen({super.key});

  @override
  State<GourmetLargeViewScreen> createState() => _GourmetLargeViewScreenState();
}

class _GourmetLargeViewScreenState extends State<GourmetLargeViewScreen> {
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          firstHalfWidget(label: 'AL Fresco (Large)  \$24.00'),
                          VerticalSpace(height: 10),
                          firstHalfWidget(label: 'Tandoori Chicken (Large)  \$24.00'),
                          VerticalSpace(height: 10),
                          firstHalfWidget(label: 'Moroccan Lamb (Large) \$24.00'),
                          VerticalSpace(height: 10),
                          firstHalfWidget(label: 'Satay Chicken (Large)  \$24.00'),
                         ...
                         Column(
                          ...
                          VerticalSpace(height: 15),
                          secondHalfWidget(label: 'AL Fresco (Large)  \$24.00'),
                          VerticalSpace(height: 10),
                          secondHalfWidget(label: 'Tandoori Chicken (Large)  \$24.00'),
                          VerticalSpace(height: 10),
                          secondHalfWidget(label: 'Moroccan Lamb (Large) \$24.00'),
                          VerticalSpace(height: 10),
                          secondHalfWidget(label: 'Satay Chicken (Large)  \$24.00'),
