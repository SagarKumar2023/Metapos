...
class TraditionalSmallViewScreen extends StatefulWidget {
  const TraditionalSmallViewScreen({super.key});

  @override
  State<TraditionalSmallViewScreen> createState() => _TraditionalSmallViewScreenState();
}

class _TraditionalSmallViewScreenState extends State<TraditionalSmallViewScreen> {
  ...
  final List<String> firstHalfData = [
    'Napoletana (Large)  \$22.00', 'Pepperoni (Large)  \$22.00',
