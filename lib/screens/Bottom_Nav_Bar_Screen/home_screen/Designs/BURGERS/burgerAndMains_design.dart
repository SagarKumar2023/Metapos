...
class BurgerAndMainsDesign extends StatelessWidget {
  const BurgerAndMainsDesign({super.key});
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            return TraditionalPizzaDesign(
                productName: 'Tandoori Chicken Burger',
                productDesc: 'All mains come with a choice of Chips or salad',
                productPrice: '\$ 19.00',
                productImage: 'assets/images/burger.jpg'
            ) ;
          },
        ),
      ],
