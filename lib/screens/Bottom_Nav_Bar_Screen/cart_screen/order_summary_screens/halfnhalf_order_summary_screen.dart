...
class HalfNHalfOrderSummaryScreen extends StatefulWidget {
  final int addSingleHalfItemByIndex ;
  ...
  const HalfNHalfOrderSummaryScreen({super.key, required this.productName, required this.qty, required this.productPrice, required this.id, required this.productTotalPrice, required this.grandTotalPrice, required this.firstHalfAddonData, required this.secondHalfAddonData, required this.firstHalfRemoveData, required this.secondHalfRemoveData, required this.productDesc, required this.addSingleHalfItemByIndex,});

  @override
  State<HalfNHalfOrderSummaryScreen> createState() => _HalfNHalfOrderSummaryScreenState();
}

class _HalfNHalfOrderSummaryScreenState extends State<HalfNHalfOrderSummaryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //                 //     desc: 'Android Course'
      //                 // );
      //               final orderBox = HiveBoxes.halfAndHalfOrderHiveBox();
      //               final productBox = HiveBoxes.halfAndHalfAddToCartHiveBox();
      //
      //               final model = HalfAndHalfOrderHiveBoxModel(
      //                   productPrice: widget.productPrice,
      //                   productName: widget.productName,
      //                   productTotalPrice: widget.productTotalPrice,
      //                   productId: widget.id,
      //                   secondHalfSelectedRemoveItems: widget.secondHalfRemoveData,
      //                   grandTotalPrice: widget.grandTotalPrice.toString(),
      //                   qty: widget.qty,
      //                   secondHalfRemoveData: widget.secondHalfRemoveData,
      //                   secondHalfAddonData: widget.secondHalfAddonData,
      //                   firstHalfRemoveData: widget.firstHalfRemoveData,
      //                   firstHalfAddonData: widget.firstHalfAddonData,
      //                 productDesc: widget.productDesc.toString()
      //               );
      //               orderBox.add(model);
      //               final keyToDelete = productBox.keys.firstWhere(
      //                     (key) => productBox.get(key)?.productId == widget.id,
      //                 orElse: () => null,
      //               );
      //
      //               if (keyToDelete != null) {
      ...
      bottomSheet: Container(
          ...
          child: selectedPayment == 'Online Payment' ? MyButton(
              ...
              buttonName: 'Pay Securely \$ ${widget.productTotalPrice}'
          ): MyButton(
              radius: 12,
              height: 50,
              buttonColor: Colors.red,
              navigateTo: () {
                Future.microtask(() async {
                  if (internetController.isOnline.value) {
                    final halfAndHalfBox = HiveBoxes.halfAndHalfAddToCartDB();
                    final selectedItem = halfAndHalfBox.getAt(widget.addSingleHalfItemByIndex);

                    if (selectedItem == null) {
                      SnackBarUtils.showWarning("Error", "Item not found!");
                      return;
                    }
                    final singleItemData = SubmitOrderAllProducts.orderSingleHalfNHalfItem(selectedItem);
                    var body = {
                    ...
                    final halfAndHalfSingleOrderBox = HiveBoxes.halfAndHalfHoldSingleOrderListDB();
                    halfAndHalfSingleOrderBox.add(HalfAndHalfHoldSingleOrderDBModel(
                      productPrice: widget.productPrice,
                      productName: widget.productName,
                      productTotalPrice: widget.productTotalPrice,
                      productId: widget.id,
                    ...
                    halfAndHalfBox.deleteAt(widget.addSingleHalfItemByIndex);
              ...
              //   final selectedItem = box.getAt(widget.addSingleHalfItemByIndex);
              //
              //   if (selectedItem == null) {
              //     SnackBarUtils.showWarning("Error", "Item not found!");
              //     return;
              ...
              //     "special_deal_discount": "[]"
              //   };
              //   categoryController.submitOrder(
              //   body: body,
              //   submitType: OrderSubmitType.halfNHalfSingle,
              //   index: widget.addSingleHalfItemByIndex,
              //   );
              // },
              buttonName: internetController.isOnline.value ?'Order \$${widget.productTotalPrice}':"No Internet",
              // buttonName: 'Submit Order \$${widget.productTotalPrice}'
          )
          // SizedBox(
          //   height: 80,
          //   child: Column(
          ...
          //             //   };
          //             //
          //             //   await categoryController.submitOrder(body);
          //             //
          //             //   box.deleteAt(widget.addSingleHalfItemByIndex);
          //             //   Get.back();
          //             //
          //             // },
          //
          ...
          //               };
          //
          //               bool orderSuccess = await categoryController.submitOrder(body);
          //
          //               if (orderSuccess) {
          //                 box.deleteAt(widget.addSingleHalfItemByIndex);
          //                 Get.back();
