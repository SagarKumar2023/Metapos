...
import 'package:metapos_sync_order_online_ofline/screens/Bottom_Nav_Bar_Screen/cart_screen/order_summary_screens/my_order_screens/my_order_screen_ui/special_deal_order_details_screen.dart';
...
class SpecialDealOrderUi extends StatefulWidget {
  const SpecialDealOrderUi({super.key});

  @override
  State<SpecialDealOrderUi> createState() => _SpecialDealOrderUiState();
}

class _SpecialDealOrderUiState extends State<SpecialDealOrderUi> {
  final finalController = Get.find<CartAllItemsTotalPriceController>();

  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: HiveBoxes.specialDealsHoldSingleOrderListDB().listenable(),
                  ...
                  child: InkWell(
                    onTap: () {
                      PersistentNavBarNavigator.pushNewScreen(
                        context,
                        screen: SpecialDealOrderDetailsScreen(
                            dealName: product.dealName.toString(),
