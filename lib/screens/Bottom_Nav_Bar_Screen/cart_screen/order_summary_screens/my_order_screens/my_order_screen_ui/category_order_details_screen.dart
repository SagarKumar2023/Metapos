...
class CategoryOrderDetailsScreen extends StatefulWidget {
  ...
  const CategoryOrderDetailsScreen({super.key, required this.productName, required this.qty, required this.productPrice, required this.id, required this.variantOption, required this.productTotalPrice, required this.productDesc, required this.grandTotalPrice,});

  @override
  State<CategoryOrderDetailsScreen> createState() => _CategoryOrderDetailsScreenState();
}

class _CategoryOrderDetailsScreenState extends State<CategoryOrderDetailsScreen> {
