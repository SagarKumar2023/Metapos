...
class CategoryHoldSingleOrderListUi extends StatefulWidget {
  const CategoryHoldSingleOrderListUi({super.key});

  @override
  State<CategoryHoldSingleOrderListUi> createState() => _CategoryHoldSingleOrderListUiState();
}

class _CategoryHoldSingleOrderListUiState extends State<CategoryHoldSingleOrderListUi> {
  final finalController = Get.find<CartAllItemsTotalPriceController>();

  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: HiveBoxes.categoryHoldSingleOrderListDB().listenable(),
