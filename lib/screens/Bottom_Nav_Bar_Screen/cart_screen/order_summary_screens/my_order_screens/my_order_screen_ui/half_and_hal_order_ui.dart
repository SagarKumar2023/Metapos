...
class HalfAndHalfHoldSingleOrderListUi extends StatefulWidget {
  const HalfAndHalfHoldSingleOrderListUi({super.key});

  @override
  State<HalfAndHalfHoldSingleOrderListUi> createState() => _HalfAndHalfHoldSingleOrderListUiState();
}

class _HalfAndHalfHoldSingleOrderListUiState extends State<HalfAndHalfHoldSingleOrderListUi> {
  final finalController = Get.find<CartAllItemsTotalPriceController>();

  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: HiveBoxes.halfAndHalfHoldSingleOrderListDB().listenable(),
                    ...
                    onTap: () {
                      PersistentNavBarNavigator.pushNewScreen(
                        ...
                        screen: HalfAndHalfOrderDetailsScreen(
                            ...
                            grandTotalPrice: double.parse(product.grandTotalPrice),
                            firstHalfAddonData: product.firstHalfAddonData,
                            secondHalfAddonData: product.secondHalfAddonData,
                            firstHalfRemoveData: product.firstHalfRemoveData,
                            secondHalfRemoveData: product.secondHalfRemoveData,
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        // Html(
                                        //   data: getLimitedHtmlText(product.),
                                        //   shrinkWrap: true,
                                        //   style: {
                                        //     "body": Style(
