...
class DealOrderDetailsScreen extends StatefulWidget {
  ...
  const DealOrderDetailsScreen({super.key, required this.dealName, required this.dealPrice, required this.dealTotalPrice, required this.dealFoodName, required this.dealCategory, required this.dealQty, required this.dealNoOfItem, required this.dealId, required this.dealDesc,});

  @override
  State<DealOrderDetailsScreen> createState() => _DealOrderDetailsScreenState();
}

class _DealOrderDetailsScreenState extends State<DealOrderDetailsScreen> {
