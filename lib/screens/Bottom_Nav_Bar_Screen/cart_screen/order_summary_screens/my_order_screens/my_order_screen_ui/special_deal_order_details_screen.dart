...
class SpecialDealOrderDetailsScreen extends StatefulWidget {
  ...
  const SpecialDealOrderDetailsScreen({super.key, required this.dealName, required this.dealPrice, required this.dealTotalPrice, required this.dealFoodName, required this.dealCategory, required this.dealQty, required this.dealNoOfItem, required this.dealId, required this.dealDesc,});

  @override
  State<SpecialDealOrderDetailsScreen> createState() => _SpecialDealOrderDetailsScreenState();
}

class _SpecialDealOrderDetailsScreenState extends State<SpecialDealOrderDetailsScreen> {
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                ...
                                TextSpan(
                                  text: 'Cash On Delivery: \$ ${widget.dealTotalPrice}',
                                  style: GoogleFonts.vidaloka(
                                    textStyle: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w500,
