...
class SpecialDealsOrderSummaryScreen extends StatefulWidget {
  final String dealName;
  final String dealPrice;
  final String dealTotalPrice;
  final List<String?> dealFoodName; // updated
  final List<String> dealCategory;  // updated
  final int dealQty;
  final List<String> dealNoOfItem;  // updated
  final String dealId;
  final String dealDesc ;

  const SpecialDealsOrderSummaryScreen({super.key, required this.dealName, required this.dealPrice, required this.dealTotalPrice, required this.dealFoodName, required this.dealCategory, required this.dealQty, required this.dealNoOfItem, required this.dealId, required this.dealDesc,});

  @override
  State<SpecialDealsOrderSummaryScreen> createState() => _SpecialDealsOrderSummaryScreenState();
}

class _SpecialDealsOrderSummaryScreenState extends State<SpecialDealsOrderSummaryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            children: [
              if(selectedPayment == 'Online Payment')
                MyButton(
                    ...
                    navigateTo: () {
                      ...
                      razorpayService.openCheckout(
                        ...
                        name: "Sagar kumar",
                        contact: "7295992604",
                        email: "sagarcodegenit@gmail.com",
                        amount: double.parse(widget.dealTotalPrice),
                        desc: widget.dealDesc,
                      );
                    },
                ...
                MyButton(
                    ...
                    buttonColor: Colors.red,
                    navigateTo: (){
                      final specialAddToCartBox = HiveBoxes.specialDealsAddToCartDB();
                      final specialOrderBox = HiveBoxes.specialDealsHoldSingleOrderListDB();

                      final model = SpecialDealsHoldSingleOrderListDBModel(
                      ...
                      specialOrderBox.add(model);
                      final keyToDeleteCart = specialAddToCartBox.keys.firstWhere((key) => specialOrderBox.get(key)?.dealId == widget.dealId,orElse: null ,);
                      if(keyToDeleteCart != null){
                        specialAddToCartBox.delete(keyToDeleteCart);
                      }
      ...
      //               //     desc: 'Android Course'
      //               // );
      //               final specialAddToCartBox = HiveBoxes.specialDealsAddToCartHiveBox();
      //               final specialOrderBox = HiveBoxes.specialDealsOrderHiveBox();
      //
      //               final model = SpecialDealsOrderHiveBoxModel(
      //                   dealCategory: widget.dealCategory,
      //                   dealFoodName: widget.dealFoodName,
      //                   dealNoOfItem: widget.dealNoOfItem,
      //                   dealId: widget.dealId,
