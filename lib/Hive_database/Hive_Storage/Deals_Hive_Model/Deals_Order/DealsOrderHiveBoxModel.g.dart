...
part of 'DealsOrderHiveBoxModel.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class DealsHoldSingleOrderListDBModelAdapter
    extends TypeAdapter<DealsHoldSingleOrderListDBModel> {
  @override
  final int typeId = 15;

  @override
  DealsHoldSingleOrderListDBModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return DealsHoldSingleOrderListDBModel(
  ...
  @override
  void write(BinaryWriter writer, DealsHoldSingleOrderListDBModel obj) {
    writer
      ..writeByte(9)
      ..writeByte(0)
      ..write(obj.dealName)
  ...
  bool operator ==(Object other) =>
      ...
      other is DealsHoldSingleOrderListDBModelAdapter &&
