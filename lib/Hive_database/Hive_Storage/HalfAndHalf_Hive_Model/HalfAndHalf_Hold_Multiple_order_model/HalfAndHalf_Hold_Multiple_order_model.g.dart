...
part of 'HalfAndHalf_Hold_Multiple_order_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class HalfAndHalfHoldMultipleOrderDBModelAdapter
    extends TypeAdapter<HalfAndHalfHoldMultipleOrderDBModel> {
  @override
  final int typeId = 40;

  @override
  HalfAndHalfHoldMultipleOrderDBModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return HalfAndHalfHoldMultipleOrderDBModel(
  ...
  @override
  void write(BinaryWriter writer, HalfAndHalfHoldMultipleOrderDBModel obj) {
    writer
      ..writeByte(27)
      ..writeByte(0)
  ...
  bool operator ==(Object other) =>
      ...
      other is HalfAndHalfHoldMultipleOrderDBModelAdapter &&
