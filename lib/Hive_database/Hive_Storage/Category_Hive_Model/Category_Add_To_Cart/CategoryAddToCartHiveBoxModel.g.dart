...
part of 'CategoryAddToCartHiveBoxModel.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class CategoryAddToCartDBModelAdapter
    extends TypeAdapter<CategoryAddToCartDBModel> {
  @override
  final int typeId = 6;

  @override
  CategoryAddToCartDBModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return CategoryAddToCartDBModel(
      id: fields[0] as int,
  ...
  @override
  void write(BinaryWriter writer, CategoryAddToCartDBModel obj) {
    writer
      ..writeByte(21)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is CategoryAddToCartDBModelAdapter &&
