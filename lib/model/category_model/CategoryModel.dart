...
//       "sequence": sequence,
//       "sub_category_new":
//       subCategoryNew.map((e) => e.toJson()).toList(),
...
// /// CatFoodList
// @HiveType(typeId: 21)
// class CatFoodList extends HiveObject {
//   CatFoodList({
//     required this.id,
//     this.oldId,
...
//   @HiveField(47)
//   late final Null priceUpdateDate;
//   @HiveField(48)
//   late final Null productExpiryDate;
//   @HiveField(49)
...
//   @HiveField(60)
//   // late final CatFoodListWithDetails foodListWithDetails;
...
//
//   CatFoodList.fromJson(Map<String, dynamic> json){
//     id = json['id'];
//     oldId = null;
...
//         ? CatFoodListWithDetails.fromJson(json['food_list_with_details'])
//         : null;
...
//     // _data['food_list_with_details'] = foodListWithDetails.toJson();
...
//
// @HiveType(typeId: 22)
// class CatFoodListWithDetails extends HiveObject {
//   CatFoodListWithDetails({
//     required this.id,
//     required this.name,
...
//   @HiveField(12)
//   // late final List<CatVariantDataArray>? variantDataArray;
...
//   late final int familyGroupId;
//
//   CatFoodListWithDetails.fromJson(Map<String, dynamic> json){
//     id = json['id'];
//     name = json['name'];
...
//     //variantDataArray = List.from(json['variantDataArray']).map((e)=>CatVariantDataArray.fromJson(e)).toList();
...
//         .toList()
//         : [];
//     // addonsDataArray = List.from(json['addonsDataArray']).map((e)=>CatAddonsDataArray.fromJson(e)).toList();
//     catId = json['cat_id'];
...
//   @HiveField(15)
//   late final List<CatFoodList> foodList;
//
...
//     foodList = List.from(json['food_list']).map((e)=>CatFoodList.fromJson(e)).toList();
//   }
//
//   Map<String, dynamic> toJson() {
//     final _data = <String, dynamic>{};
...
//     _data['name'] = name;
//     _data['amount'] = amount;
//     _data['save_amount'] = saveAmount;
//     _data['desc'] = desc;
//     _data['show_app'] = showApp;
//     _data['show_web'] = showWeb;
//     _data['show_pos'] = showPos;
//     _data['is_this_price'] = isThisPrice;
//     _data['show_qrcode'] = showQrcode;
//     _data['deal_data'] = dealData.map((e)=>e.toJson()).toList();
