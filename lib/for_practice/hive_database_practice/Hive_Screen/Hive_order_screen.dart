...
class HiveOrderScreen extends StatefulWidget {
  const HiveOrderScreen({super.key});

  @override
  State<HiveOrderScreen> createState() => _HiveOrderScreenState();
}

class _HiveOrderScreenState extends State<HiveOrderScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ValueListenableBuilder(
          valueListenable: HiveBoxes.productOrderBox().listenable(),
                ...
                return data.isEmpty ? Center(
                  ...
                  child: Column(
                    children: [
                      ...
                      //     GestureDetector(
                      //       onTap: (){
                      //         final pCartBox = HiveBoxes.productCartBox();
                      //         final pOrderBox = HiveBoxes.productOrderBox();
                      //         final item = data[index];
                      //         pOrderBox.add(item);
                      //         pCartBox.deleteAt(index);
                      ...
                      GestureDetector(
                        onTap: ()async{
                          var box = HiveBoxes.productOrderBox();
